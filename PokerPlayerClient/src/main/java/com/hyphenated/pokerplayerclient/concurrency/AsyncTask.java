...
/**
 * Override Android's OS implementation of Async Task.  When targeting API 9
 * and other older versions of the OS, there are occasionally issues with
 * the android Async Task, especially if you want multiple Async Tasks.
 * <br /><br />
 * This implementation (taken from stack overflow) leverages later versions
 * of the Async Task class with compatibility to early versions of the OS.
 */
